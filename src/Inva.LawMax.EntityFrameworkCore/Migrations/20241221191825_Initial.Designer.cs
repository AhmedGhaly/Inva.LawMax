...
namespace Inva.LawMax.Migrations
{
    ...
    [Migration("20241221191825_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inva.LawMax.LawCases.Case", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inva.LawMax.LawCases.CaseLawyer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inva.LawMax.LawCases.Hearing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inva.LawMax.LawCases.Lawyer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inva.LawMax.LawCases.CaseLawyer", b =>
                {
                    b.HasOne("Inva.LawMax.LawCases.Case", "Case")
                        .WithMany("CaseLawyers")
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Inva.LawMax.LawCases.Lawyer", "Lawyer")
                        .WithMany("CaseLawyers")
